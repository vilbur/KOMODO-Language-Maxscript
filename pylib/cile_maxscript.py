...
"""A Code Intelligence Language Engine for the Maxscript language.
...
class MaxscriptCILEError(CILEError):
    pass
...
log = logging.getLogger("cile.maxscript")
...
def scan_buf(buf, mtime=None, lang="Maxscript"):
    """Scan the given MaxscriptBuffer return an ElementTree (conforming
    ...
    """
    # Dev Notes:
    # - This stub implementation of the Maxscript CILE return an "empty"
    #   summary for the given content, i.e. CIX content that says "there
    #   are no code elements in this Maxscript content".
    # - Use the following command (in the extension source dir) to
    #   debug/test your scanner:
    #       codeintel scan -p -l Maxscript <example-Maxscript-file>
    ...
    # Dev Note:
    # This is where you process the Maxscript content and add CIX elements
    ...
    #   Use the "codeintel html -b <example-Maxscript-file>" command as
    #   a debugging tool.
    # - "buf.accessor.text" is the whole content of the file. If you have
    #   a separate tokenizer/scanner tool for Maxscript content, you may
    #   want to use it.
